        ...
        {!data ? (
          ...
          <>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
              <ReportLink href="/cockpit/insights" title="Experiențe de învățare" description="Feedback loops, autonomie" icon="🧠" />
              <ReportLink href="/cockpit/reports/agents" title="Evoluție agenți" description="Maturitate, KB hit" icon="📊" />
              <ReportLink href="/cockpit/reports/daily" title="Raport zilnic" description="Performanță, cicluri" icon="📅" />
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
              <ReportLink href="/cockpit/reports/business-plan" title="Business Plan" description="Obiective, strategie, termene" icon="📈" />
              <ReportLink href="/cockpit/reports/costs" title="Costuri operare" description="LLM, infra, per agent" icon="💰" />
              <ReportLink href="/cockpit/reports/evolution" title="Evoluție Owner" description="Aliniere, pattern-uri" icon="🪞" />
            </div>
            ...
            {ownerDecisions.length > 0 ? (
              <div className="bg-white rounded-2xl border border-slate-200" style={{ padding: "28px" }}>
                <div className="flex items-center justify-between">
                  ...
                  <Link href="/cockpit/situations" className="text-[10px] text-indigo-600 hover:underline">Toate situațiile →</Link>
                </div>
                <div style={{ height: "16px" }} />
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <Link href="/cockpit/team" className="block rounded-2xl border border-indigo-100 bg-white hover:bg-indigo-50 transition-all" style={{ padding: "20px" }}>
              ...
              <Link href="/cockpit/docs" className="block rounded-2xl border border-slate-200 bg-white hover:bg-slate-50 transition-all" style={{ padding: "20px" }}>
                <span className="text-xl">📚</span>
                <div style={{ height: "8px" }} />
            ...
            <div className="bg-white rounded-2xl border border-slate-200" style={{ padding: "28px" }}>
              ...
              <div className="flex flex-wrap gap-3">
                ...
                <QuickLink href="/cockpit/payroll" label="Payroll" />
                <QuickLink href="/cockpit/situations" label="Situații" />
