...
export default function MasterSimulatorLayout({ data, isDemo = false, masterContent, simulatorContent }: Props) {
  ...
  return (
    <SimulatorContext.Provider value={contextValue}>
      <div className="flex justify-center gap-8 px-8 transition-all duration-300">
        {/* Master — stânga (mereu centrat, aceeași lățime) */}
        <div className="max-w-[1000px] flex-1 min-w-0 overflow-x-hidden transition-all duration-300">
          {masterContent}
        </div>
