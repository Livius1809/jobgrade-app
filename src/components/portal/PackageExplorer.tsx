...
const PACKAGES: PackageInfo[] = [
  {
    ...
    price: "Calculator personalizat",
    priceDetail: "Cost pe baza nr. poziții + nr. salariați. Plată unică.",
    demoHref: "/demo",
  ...
  },
  {
    ...
    price: "Calculator personalizat",
    priceDetail: "Include Ordine internă + structura salarială + pay gap. Cost pe poziții + salariați.",
    demoHref: "/demo",
    activateHref: "/sessions",
    color: "violet",
  ...
  },
  {
    ...
    price: "Calculator personalizat",
    priceDetail: "Include Ordine internă + Conformitate + benchmark piață. Cost pe poziții + salariați.",
    demoHref: "/demo",
    activateHref: "/sessions",
    color: "fuchsia",
  ...
  },
  {
    ...
    price: "Calculator personalizat",
    priceDetail: "Pachetul complet. Include toate straturile. Cost pe poziții + salariați.",
    demoHref: "/demo",
    activateHref: "/sessions",
    color: "coral",
