...
export const MEDIA_BOOKS: MediaBookConfig[] = [
  ...
  },
  {
    ...
    subtitle: "Raportare conform Art. 9 din Directiva EU 2023/970",
    type: "Raport",
    icon: "⚖️",
  },
  {
    ...
    subtitle: "Evaluare angajator-angajați conform Art. 10 din Directiva EU 2023/970",
    type: "Raport",
    icon: "🤝",
  },
  {
    ...
    title: "Evaluarea personalului",
    subtitle: "Evaluarea competențelor și armonizarea echipelor de lucru",
    type: "Serviciu",
    icon: "👥",
  },
  {
    ...
    title: "Managementul structurilor și echipelor mixte om-AI",
    subtitle: "Dinamica echipelor multigeneraționale și colaborarea om-AI",
    type: "Serviciu",
    icon: "🔄",
  },
  {
    ...
    title: "Procese interne și Manualul calității",
    subtitle: "Armonizarea proceselor, sistem calitate furnizor-client",
    type: "Serviciu",
    icon: "✅",
  },
  {
    ...
    title: "Cultură organizațională și performanță",
    subtitle: "Adaptare la piață, procese și probabilitate atingere obiective",
    type: "Serviciu",
    icon: "🌱",
  },
]
